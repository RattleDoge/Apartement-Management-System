...
<div class="flex h-screen overflow-hidden">
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-1">
            <x-admin.nav-item route="dashboard" icon="home">Dashboard</x-admin.nav-item>
            <div class="pt-4 pb-1">
                <p class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Manajemen</p>
            </div>
            <x-admin.nav-item route="users.index" icon="users">Pengguna</x-admin.nav-item>
            <x-admin.nav-item route="settings" icon="settings">Pengaturan</x-admin.nav-item>
        </nav>
