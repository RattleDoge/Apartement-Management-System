...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="px-6 py-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div class="bg-red-50 rounded-xl border border-red-200 p-5 shadow-sm flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs text-red-400 font-medium mb-0.5">Belum Lunas</p>
                    <p class="text-2xl font-bold text-red-600">Rp {{ number_format($belumLunas, 0, ',', '.') }}</p>
                </div>
            </div>
            <div class="bg-green-50 rounded-xl border border-green-200 p-5 shadow-sm flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs text-green-500 font-medium mb-0.5">Sudah Lunas</p>
                    <p class="text-2xl font-bold text-green-700">Rp {{ number_format($totalLunas, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
